...
public class ClientReceiverUdp2 implements Runnable {
    ...
    public ClientReceiverUdp2(WordQuizzleClient2 clientReference, int udpPortClient) throws SocketException{ //riceve solo richieste udp e le stampa
